...
// GitHub Icon
                      IconButton(
                        ...
                        constraints:
                            const BoxConstraints(), // Keep the icon button small
                        onPressed: (profile.socialMediaLinks?['GitHub'] !=
                            ...
                            : () {
                                // Show a small snackbar message if no GitHub URL
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    ...
                                    margin: EdgeInsets.only(
                                        bottom: 80), // Show above the icon
                                  ),
                                );
                              }, // Show message if no link
                      ),
...
// LinkedIn Icon
                      IconButton(
                        ...
                        onPressed: (profile.socialMediaLinks?['LinkedIn'] !=
                            ...
                            : () {
                                // Show a small snackbar message if no LinkedIn URL
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('No LinkedIn URL available'),
                                    behavior: SnackBarBehavior.floating,
                                    duration: Duration(seconds: 2),
                                    margin: EdgeInsets.only(
                                        bottom: 80), // Show above the icon
