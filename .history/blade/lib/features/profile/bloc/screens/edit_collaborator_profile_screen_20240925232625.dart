                        ...
                        children: [
                          CircleAvatar(
                            ...
                            child: CircleAvatar(
                              radius: 75,
                              backgroundColor:
                                  Colors.greenAccent, // Green shadow
                              child: CircleAvatar(
                                radius: 70,
                                backgroundImage: _newProfileImage != null
                                    ? FileImage(
                                        _newProfileImage!) // Load the selected image
                                    : (widget.profile.profilePhotoUrl != null &&
                                        ...
                                        ? NetworkImage(widget.profile
                                            .profilePhotoUrl!) // Load the URL if available
                                        : AssetImage(
                            ...
                            children: [
                              MultiSelectDialogField(
                                items: state.availableSkills
                                    ...
                                    .toList(),
                                initialValue:
                                    _selectedSkills, // Ensure previously selected skills are checked
                                onConfirm: (results) {
                                  setState(() {
                                ...
                                chipDisplay: MultiSelectChipDisplay(
                                  ...
                                  chipColor: Theme.of(context)
                                      .primaryColor, // Customize chip color
                                ),
                                ...
                                selectedColor: Colors
                                    .orange, // Set the checkmark color to orange
                                checkColor: Colors
                                    .orange, // Force the check color to orange
                              ),
                              const SizedBox(height: 16),
                            ],
                          );
