                    ...
                    BlocBuilder<EditCollaboratorProfileBloc,
                      ...
                      builder: (context, state) {
                        if (state is SkillsLoaded) {
                          // Ensure that previously selected skills from the profile are checked
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              MultiSelectDialogField(
                                items: state.availableSkills
                                    ...
                                    .toList(),
                                // Use the skills from the profile as the initial selected values
                                initialValue: widget.profile.skills ??
                                    [], // Ensure previously selected skills are checked
                                onConfirm: (results) {
                                  setState(() {
