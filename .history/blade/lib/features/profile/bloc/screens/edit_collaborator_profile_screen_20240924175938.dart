                  ...
                  builder: (context, state) {
                    if (state is SkillsLoaded) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Custom Dropdown Button for skills selection
                          DropdownButtonFormField<String>(
                            ...
                            onChanged: (selectedSkill) {
                              if (selectedSkill != null &&
                                  !_selectedSkills.contains(selectedSkill)) {
                                setState(() {
                            ...
                            decoration: const InputDecoration(
                              labelText: 'Select Skills (Optional)',
                            ),
                          ),
                          const SizedBox(height: 16),

                          // Display selected skills as custom orange chips
                          Wrap(
                            spacing: 8.0,
                            children: _selectedSkills.map((skill) {
                              return Chip(
                                label: Text(skill),
                                backgroundColor:
                                    TColors.primary, // Orange color for chips
                                deleteIconColor:
                                    Colors.white, // White delete icon
                                onDeleted: () {
                                  setState(() {
