                            ...
                            children: [
                              MultiSelectDialogField(
                                ...
                                selectedColor: const Color(
                                    0xFFFD5336), // Set the color of selected checkboxes to orange
                                checkColor: Colors
                                ...
                                // Customizing the chip display after selecting items
                                chipDisplay: MultiSelectChipDisplay(
                                  textStyle: TextStyle(
                                    color: isDarkMode
                                        ? Colors.white
                                        : Colors
                                            .black, // Text color for the selected chips
                                  ),
                                  chipColor: const Color(
                                      0xFFFD5336), // Background color of selected skill chips (orange)
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(10),
                                  ),
                                  onTap: (value) {
