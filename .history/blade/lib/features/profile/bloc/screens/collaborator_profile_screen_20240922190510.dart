        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () async {
                // Navigate to edit screen and wait for the updated profile
                ...
                // Check if updatedProfile is returned
                if (updatedProfile != null &&
                    updatedProfile is CollaboratorProfileModel) {
                  setState(() {
                    _updatedProfile =
                        updatedProfile; // Update the profile state
                  });
                }
              },
            ),
          ...
          child: BlocBuilder<ProfileViewBloc, ProfileViewState>(
            builder: (context, state) {
              if (state is ProfileLoading) {
                ...
                _updatedProfile =
                    profile; // Store the profile in _updatedProfile
