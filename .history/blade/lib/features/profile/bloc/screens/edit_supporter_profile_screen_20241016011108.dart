...
class _EditSupporterProfileScreenState
  ...
  void _onSaveButtonPressed() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Show a loading indicator during the image upload
      showDialog(
        context: context,
      ...
      try {
        ...
        // After saving, pass the updated profile back to the previous screen
        ...
        Navigator.of(context).pop(); // Dismiss the loading dialog if open
      }
    }
  }
