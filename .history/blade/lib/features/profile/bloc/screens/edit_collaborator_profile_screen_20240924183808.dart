                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          MultiSelectDialogField<String>(
                            ...
                            title: const Text('Select Skills (Optional)'),
                            buttonText: const Text('Select Skills (Optional)'),
                            ...
                            // Custom Chip display with delete functionality
                            chipDisplay: MultiSelectChipDisplay(
                              ...
                              chipColor: Colors.orange
                                  .shade400, // Customize the color as per your theme
                              textStyle: const TextStyle(color: Colors.white),

                              // We control the chip display here using this simple onTap functionality
                              icon: const Icon(
                                Icons.cancel,
                                color: Colors.white,
                                size: 18,
                          ...
                          const SizedBox(height: 16), // Add spacing as required
                        ],
                      );
