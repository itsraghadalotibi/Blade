                  ...
                  builder: (context, state) {
                    if (state is SkillsLoaded) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Skills Dropdown Menu without default chip display
                          MultiSelectDialogField(
                            items: state.availableSkills
                                .map((skill) => MultiSelectItem(skill, skill))
                                .toList(),
                            initialValue:
                                _selectedSkills, // Set initial selected skills
                            onConfirm: (results) {
                              setState(() {
                            ...
                            title: Text('Skills'),
                            buttonText: Text('Select Skills (Optional)'),
                            ...
                            chipDisplay: null, // Disable default chips
                          ),
                          const SizedBox(height: 16),
