  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title:
              const Text('Profile', style: TextStyle(color: TColors.primary)),
          backgroundColor: Colors.black,
          automaticallyImplyLeading: false, // Remove back navigation
          actions: [
            IconButton(
              icon: const Icon(Icons.edit,
                  color: TColors.primary), // Orange edit icon
              onPressed: () async {
      ...
      children: [
        Expanded(
          child: NestedScrollView(
                          ...
                          IconButton(
                            icon: FaIcon(
                              ...
                              color: profile.socialMediaLinks?['GitHub'] != null
                                  ? TColors
                                      .primary // Use orange for active icons
                                  : Colors.grey,
                              size: 24,
                            ),
                      ...
                      Wrap(
                        ...
                        children: profile.skills?.map((skill) {
                              return Chip(
                                label: Text(skill),
                                backgroundColor:
                                    TColors.primary, // Use orange for chips
            ...
            body:
                buildTabBarSection(), // Your tab bar section (Project Ideas, Ongoing, Completed)
          ),
        ),
      ],
    );
