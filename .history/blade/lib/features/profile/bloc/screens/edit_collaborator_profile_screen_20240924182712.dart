...
BlocBuilder<EditCollaboratorProfileBloc, EditCollaboratorProfileState>(
      ...
      return Column(
        ...
        children: [
          ...
          TMultiSelectDialogTheme.lightMultiSelectDialogField(
            ...
            title: 'Select Skills (Optional)',
            buttonText: 'Select Skills (Optional)',

            // Add chipDisplay to modify the default chips with delete functionality
            chipDisplay: MultiSelectChipDisplay(
              onTap: (value) {
                // This will remove the skill when the chip is tapped (delete icon behavior)
                setState(() {
                  _selectedSkills.remove(value);
                });
              },
              chipColor: Colors.orange.shade400, // Customize chip color if needed
          ...
          const SizedBox(height: 16), // <-- Ensure comma is placed at the end
        ],
      );
