  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Profile'), // Kept unchanged
          backgroundColor: Colors.black,
          actions: [
            IconButton(
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // Row with Name and Social Media Icons (icons are close to the name)
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center, // Align with name
            children: [
              Text(
              ...
              const SizedBox(width: 8), // Reduced space between name and icons
              ...
              IconButton(
                icon: FaIcon(
                  ...
                  color: profile.socialMediaLinks?['GitHub'] != null
                      ? TColors.primary // Orange for active icons
                      : Colors.grey,
                  size: 24,
                ),
          ...
          // Bio Section (Now centered properly)
          Column(
            crossAxisAlignment: CrossAxisAlignment.center, // Properly centered
            children: [
              const Text(
                'About',
                style: TextStyle(
