  ...
  Future<void> _loadMoreData() async {
    ...
    try {
      ...
      QuerySnapshot snapshot =
          (await widget.repository.fetchIdeasWithPagination(
        limit: limit,
      ...
      setState(() {
        ...
        if (snapshot.docs.isNotEmpty) {
          _lastDoc =
              snapshot.docs.last; // Save the last document for pagination
        }
      });
    } catch (e) {
              ...
              if (canJoin)
                Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color:
                          TColors.primary, // Reduced opacity for disabled look
