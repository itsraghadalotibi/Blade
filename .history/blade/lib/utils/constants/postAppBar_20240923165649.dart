...
class PostAppBar extends StatelessWidget {
  ...
  final ValueNotifier<String> _valueNotifier = ValueNotifier<String>(
      'Announcement'); // Tracks the dropdown's selected value
  final Widget child; // Accept child widget

  // Constructor with required title parameter and const optimization
  PostAppBar({super.key, required this.title, required this.child});
      ...
      body: const Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
                'hello world'), // Constant "hello world" text displayed in the center
          ],
        ),
      ),
    );
